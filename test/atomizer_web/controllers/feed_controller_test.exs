defmodule AtomizerWeb.FeedControllerTest do
  ...
  test "/feed with funimation URL renders feed", %{conn: conn} do
    ...
    <feed xmlns="http://www.w3.org/2005/Atom" xmlns:webfeeds="http://webfeeds.org/rss/1.0">
      ...
      <link href="http://anifeedilizer.com/feed?show=https://funimation.com/shows/mushoku-tensei-jobless-reincarnation" rel="self"/>
      ...
      <entry>
        ...
        <content type="text">The Greyrat family is overjoyed when Zenith announces that she's pregnant with a second child, but the mood takes a dour turn when Lilia reveals that she is also pregnant and Paul is the father. Will this be the end of Rudy's happy family?</content>
      ...
      <entry>
        ...
        <content type="text">Rudy begins to explore the village and rescues a green-haired child from a group of bullies. The two grow close practicing magic, but is there more to Rudy's new friend than he thinks?</content>
      ...
      <entry>
        ...
        <content type="text">Rudy begins training with his new magic tutor and learning swordsmanship from his father. He makes rapid progress, but traumatic memories from his past life leave him to afraid to go outside. Is his second chance already doomed to failure?</content>
      ...
      <entry>
        ...
        <content type="text">A 34-year-old unemployed recluse get hit by a truck... and wakes up as a newborn baby in a fantasy world! With loving parents, a lifetime of regrets, and a beginner's magic textbook, he sets out to make the most of his second chance at life.</content>
